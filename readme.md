...
- [Ethereum Docs](https://ethereum.org/en/developers/docs/) - Covering all things related to Ethereum. The go-to place for all things.
- [Whitepaper](https://ethereum.org/en/whitepaper/) - Non-technical introductory description of Ethereum.
...
- [Truffle Framework](https://archive.trufflesuite.com) - Development environment for blockchain applications.
- [Ganache](https://archive.trufflesuite.com/ganache/) - Personal Ethereum blockchain to run tests.
...
- [Hitchhikers Guide to Smart Contracts](https://blog.openzeppelin.com/the-hitchhikers-guide-to-smart-contracts-in-ethereum-848f08001f05) - Build smart contracts on Ethereum using Truffle, testrpc and Solidity.
...
- [Parity DApp Tutorial (Archived)](https://wiki.parity.io/Dapp-Tutorial) - 10 part tutorial on how to write DApps.
...
- [Full Stack DApp Tutorial Series](https://github.com/kauri-io/kauri-fullstack-dapp-tutorial-series?tab=readme-ov-file) - Full stack DApps using various frameworks.
...
- [Solidity Documentation - Latest](https://docs.soliditylang.org/en/v0.8.27/) - Programming language of choice for smart contracts.
...
- [Flint Documentation](https://flint.tools/manual/) - Experimental contract orientated language for Ethereum.
...
- [Smart contract safety](https://ethereum.org/en/security/#introduction) - Ethereum docs on best practices for safety in smart contracts.
...
- [Ethernaut Smart Contract Capture the Flag](https://ethernaut.openzeppelin.com) - Practice hacking Smart Contracts.
...
- [Ethereum Wiki Philosophy - Archived](https://github.com/ethereum/ethereum.org/wiki/Philosophy) - Some of the core philosophies of Ethereum.
...
- [ETH Gas Station - Retired](https://ethgasstation.info/) - A tool to check the current price of gas for transactions.
...
- [Swarm](https://www.ethswarm.org) - Swarm is a distributed storage platform and content distribution service.
- [Whisper](https://ethereum.org/en/developers/docs/networking-layer/#whisper) - A communication protocol for DApps to communicate with each other.
- [Casper](https://ethereum.org/en/developers/docs/consensus-mechanisms/pos/gasper/) - Proof of Stake Implementation.
  ...
  - [PoS FAQs](https://ethereum.org/en/developers/docs/consensus-mechanisms/pos/faqs/)
...
- [Sharding](https://ethereum.org/en/roadmap/danksharding/) - Partitioning computational resources so that nodes do not have to process the entire blockchain.
- [Web3.js](https://github.com/ethereum/web3.js) - Ethereum's JavaScript API.
- [Ethash Proof of Work](https://ethereum.org/en/developers/docs/consensus-mechanisms/pow/mining/mining-algorithms/ethash/) - Ethereum's Proof of Work Algorithm.
- [zk-SNARKS](https://ethereum.org/en/zero-knowledge-proofs/#zk-snarks) - Verify knowledge of a secret without revealing it.
  - [Introduction to zk-SNARKS](https://consensys.io/blog/introduction-to-zk-snarks) - A practical overview of zk-SNARKS.
...
- Token Bonding Curves (TBC) - Mathematically sound price-supply relationship curves.
  ...
  - [Bonding Curve Playground](https://bondingplayground.netlify.app) - An interactive bonding curve webapp.


## Books

- [Mastering Ethereum](https://github.com/ethereumbook/ethereumbook) - A developers guide to the operation and use of Ethereum.
- [Introduction to Ethereum and Solidity](https://github.com/clojurians-org/blockchain-ebook/blob/master/Introducing.Ethereum.and.Solidity.pdf) - Learn Solidity development from concept to deployment.
...
- [Ethereum Ecosystem](https://www.ethereum-ecosystem.com) - A comprehensive list of the Decentralized Applications (DApps) on Ethereum.
